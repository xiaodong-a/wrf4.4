...
DO itrace = PARAM_FIRST_SCALAR , num_chem
  IF ( chem_boundary_table(grid%id, itrace ) ) THEN
    CALL wrf_ext_write_field (  &
          fid                             , &  
          current_date(1:19)              , &  
          TRIM(chem_dname_table( grid%id, itrace )) // '_BXS', & 
          grid%chem_BXS(jms,kds,1,itrace)  , &  
                       WRF_FLOAT             , &  
          grid , &  
          grid%domdesc       , &  
          grid%bdy_mask       , &  
...
'inc/wrf_bdyout.inc ext_write_field '//TRIM(chem_dname_table( grid%id, itrace ))//' memorder XSZ' , & 
...
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
    ...
    CALL wrf_ext_write_field (  &
          fid                             , &  
          current_date(1:19)              , &  
          TRIM(chem_dname_table( grid%id, itrace )) // '_BXE', & 
          grid%chem_BXE(jms,kds,1,itrace)  , &  
                       WRF_FLOAT             , &  
          grid , &  
          grid%domdesc       , &  
          grid%bdy_mask       , &  
          ...
          chem_desc_table( grid%id, itrace  ), & 
          chem_units_table( grid%id, itrace  ), & 
'inc/wrf_bdyout.inc ext_write_field '//TRIM(chem_dname_table( grid%id, itrace ))//' memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                         ierr )
    CALL wrf_ext_write_field (  &
          fid                             , &  
          current_date(1:19)              , &  
          TRIM(chem_dname_table( grid%id, itrace )) // '_BYS', & 
          grid%chem_BYS(ims,kds,1,itrace)  , &  
                       WRF_FLOAT             , &  
          grid , &  
          grid%domdesc       , &  
          grid%bdy_mask       , &  
          ...
          chem_desc_table( grid%id, itrace  ), & 
          chem_units_table( grid%id, itrace  ), & 
'inc/wrf_bdyout.inc ext_write_field '//TRIM(chem_dname_table( grid%id, itrace ))//' memorder YSZ' , & 
...
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
    ...
    CALL wrf_ext_write_field (  &
          fid                             , &  
          current_date(1:19)              , &  
          TRIM(chem_dname_table( grid%id, itrace )) // '_BYE', & 
          grid%chem_BYE(ims,kds,1,itrace)  , &  
                       WRF_FLOAT             , &  
          grid , &  
          grid%domdesc       , &  
          grid%bdy_mask       , &  
          ...
          chem_desc_table( grid%id, itrace  ), & 
          chem_units_table( grid%id, itrace  ), & 
'inc/wrf_bdyout.inc ext_write_field '//TRIM(chem_dname_table( grid%id, itrace ))//' memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                         ierr )
...
DO itrace = PARAM_FIRST_SCALAR , num_chem
  IF ( chem_boundary_table(grid%id, itrace ) ) THEN
    CALL wrf_ext_write_field (  &
          fid                             , &  
          current_date(1:19)              , &  
          TRIM(chem_dname_table( grid%id, itrace )) // '_BTXS', & 
          grid%chem_BTXS(jms,kds,1,itrace)  , &  
                       WRF_FLOAT             , &  
          grid , &  
          grid%domdesc       , &  
          grid%bdy_mask       , &  
...
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
    ...
    CALL wrf_ext_write_field (  &
          fid                             , &  
          current_date(1:19)              , &  
          TRIM(chem_dname_table( grid%id, itrace )) // '_BTXE', & 
          grid%chem_BTXE(jms,kds,1,itrace)  , &  
                       WRF_FLOAT             , &  
          grid , &  
          grid%domdesc       , &  
          grid%bdy_mask       , &  
...
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
    ...
    CALL wrf_ext_write_field (  &
          fid                             , &  
          current_date(1:19)              , &  
          TRIM(chem_dname_table( grid%id, itrace )) // '_BTYS', & 
          grid%chem_BTYS(ims,kds,1,itrace)  , &  
                       WRF_FLOAT             , &  
          grid , &  
          grid%domdesc       , &  
          grid%bdy_mask       , &  
...
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
    ...
    CALL wrf_ext_write_field (  &
          fid                             , &  
          current_date(1:19)              , &  
          TRIM(chem_dname_table( grid%id, itrace )) // '_BTYE', & 
          grid%chem_BTYE(ims,kds,1,itrace)  , &  
                       WRF_FLOAT             , &  
          grid , &  
          grid%domdesc       , &  
          grid%bdy_mask       , &  
