MODULE module_optional_input
   ...
   INTEGER :: flag_qv       , flag_qc       , flag_qr       , flag_qi       , flag_qs       , &
              ...
              flag_qnwfa2d  , flag_qnifa2d  , flag_qnbca2d  , flag_qnocbb2d , flag_qnbcbb2d , &
              flag_qnwfa    , flag_qnifa    , flag_qnbca    , &
              flag_qnwfa_cl , flag_qnifa_cl , flag_qnbca_cl , &
              flag_p_wif    , &
...
USE module_io_domain
      ...
      IF ( ierr .EQ. 0 ) THEN
         flag_qnh       = itmp
      END IF
      flag_name(1:8) = 'QNWFA2D '
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_qnwfa2d   = itmp
      END IF
      flag_name(1:8) = 'QNIFA2D '
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_qnifa2d   = itmp
      END IF
      flag_name(1:8) = 'QNBCA2D '
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_qnbca2d   = itmp
      END IF
      flag_name(1:8) = 'QNOCBB2D'
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_qnocbb2d   = itmp
      END IF
      flag_name(1:8) = 'QNBCBB2D'
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_qnbcbb2d   = itmp
      END IF
      ...
      IF ( ierr .EQ. 0 ) THEN
         flag_qnbca     = itmp
      END IF
      flag_name(1:8) = 'QNWFA_CL'
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_qnwfa_cl  = itmp
      END IF
      flag_name(1:8) = 'QNIFA_CL'
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_qnifa_cl  = itmp
      END IF
      flag_name(1:8) = 'QNBCA_CL'
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_qnbca_cl  = itmp
      END IF
      ...
      IF ( ierr .EQ. 0 ) THEN
         flag_speccldf = itmp
      END IF
      flag_name(1:8) = 'CLDMASK '
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_cldmask = itmp
      END IF
      flag_name(1:8) = 'CLDBASEZ'
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_cldbasez = itmp
      END IF
      flag_name(1:8) = 'CLDTOPZ '
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_cldtopz = itmp
      END IF
      flag_name(1:8) = 'BRTEMP  '
      CALL wrf_get_dom_ti_integer ( fid, 'FLAG_' // flag_name, itmp, 1, icnt, ierr )
      IF ( ierr .EQ. 0 ) THEN
         flag_brtemp = itmp
      END IF
