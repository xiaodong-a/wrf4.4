...
DO itrace = PARAM_FIRST_SCALAR , num_chem
  IF ( chem_boundary_table(grid%id, itrace ) ) THEN
    CALL wrf_ext_read_field (  &
          ...
          'XSZ'               , &  
          ''                , &  
'inc/wrf_bdyin.inc ext_write_field '//TRIM(chem_dname_table( grid%id, itrace ))//' memorder XSZ' , & 
...
MAX(jms,jds), MIN(jme,(jde-1)), kds, (kde-1), 1, config_flags%spec_bdy_width, &
    ...
    CALL wrf_ext_read_field (  &
          ...
          'XEZ'               , &  
          ''                , &  
'inc/wrf_bdyin.inc ext_write_field '//TRIM(chem_dname_table( grid%id, itrace ))//' memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
MAX(jms,jds), MIN(jme,(jde-1)), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                         ierr )
    CALL wrf_ext_read_field (  &
          ...
          'YSZ'               , &  
          ''                , &  
'inc/wrf_bdyin.inc ext_write_field '//TRIM(chem_dname_table( grid%id, itrace ))//' memorder YSZ' , & 
...
MAX(ims,ids), MIN(ime,(ide-1)), kds, (kde-1), 1, config_flags%spec_bdy_width, &
    ...
    CALL wrf_ext_read_field (  &
          ...
          'YEZ'               , &  
          ''                , &  
'inc/wrf_bdyin.inc ext_write_field '//TRIM(chem_dname_table( grid%id, itrace ))//' memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
MAX(ims,ids), MIN(ime,(ide-1)), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                         ierr )
