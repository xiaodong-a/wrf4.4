...
rate_loop: &
   ...
   select case( config_flags%chem_opt )
     case( mozart_mosaic_4bin_aq_kpp )
       ...
       ph_no3o(i,kts:kte,j) = tuv_prate(kts:kte,8) + tuv_prate(kts:kte,9)
       ph_hno4(i,kts:kte,j) = tuv_prate(kts:kte,10)
       ph_h2o2(i,kts:kte,j) = tuv_prate(kts:kte,11)
       ph_ch3o2h(i,kts:kte,j) = tuv_prate(kts:kte,12)
       ph_ch2or(i,kts:kte,j) = tuv_prate(kts:kte,13)
       ph_ch2om(i,kts:kte,j) = tuv_prate(kts:kte,14)
       ph_ch3cho(i,kts:kte,j) = tuv_prate(kts:kte,15) + tuv_prate(kts:kte,16) + tuv_prate(kts:kte,17)
       ph_pooh(i,kts:kte,j) = tuv_prate(kts:kte,18)
       ph_pan(i,kts:kte,j) = tuv_prate(kts:kte,19) + tuv_prate(kts:kte,20)
       ph_macr(i,kts:kte,j) = tuv_prate(kts:kte,21)
       ph_mvk(i,kts:kte,j) = tuv_prate(kts:kte,22)
       ph_ch3coch3(i,kts:kte,j) = tuv_prate(kts:kte,23)
       ph_ch3cocho(i,kts:kte,j) = tuv_prate(kts:kte,24)
       ph_hyac(i,kts:kte,j) = tuv_prate(kts:kte,25) + tuv_prate(kts:kte,26)
       ph_glyald(i,kts:kte,j) = tuv_prate(kts:kte,27) + tuv_prate(kts:kte,28) + tuv_prate(kts:kte,29)
       ph_mek(i,kts:kte,j) = tuv_prate(kts:kte,30)
       ph_gly(i,kts:kte,j) = tuv_prate(kts:kte,31) + tuv_prate(kts:kte,32) + tuv_prate(kts:kte,33)
       ph_hno2(i,kts:kte,j) = tuv_prate(kts:kte,34)
...
is_initialized: &
   ...
   select case( config_flags%chem_opt )
     case( mozart_mosaic_4bin_aq_kpp )
       ...
       tuv_jname(10) = 'j_hno4'
       tuv_jname(11) = 'j_h2o2'
       tuv_jname(12) = 'j_ch3ooh'
       tuv_jname(13) = 'j_ch2o_r'
       tuv_jname(14) = 'j_ch2o_m'
       tuv_jname(15) = 'j_ch3cho_a'
       tuv_jname(16) = 'j_ch3cho_b'
       tuv_jname(17) = 'j_ch3cho_c'
       tuv_jname(18) = 'j_hoch2ooh'
       tuv_jname(19) = 'j_pan_a'
       tuv_jname(20) = 'j_pan_b'
       tuv_jname(21) = 'j_macr'
       tuv_jname(22) = 'j_mvk'
       tuv_jname(23) = 'j_ch3coch3'
       tuv_jname(24) = 'j_mgly'
       tuv_jname(25) = 'j_hyac_a'
       tuv_jname(26) = 'j_hyac_b'
       tuv_jname(27) = 'j_glyald_a'
       tuv_jname(28) = 'j_glyald_b'
       tuv_jname(29) = 'j_glyald_c'
       tuv_jname(30) = 'j_mek'
       tuv_jname(31) = 'j_gly_a'
       tuv_jname(32) = 'j_gly_b'
       tuv_jname(33) = 'j_gly_c'
       tuv_jname(34) = 'j_hno2'
       j_o2_ndx = 1
     case( mozart_mosaic_4bin_kpp )
       nj = 34
