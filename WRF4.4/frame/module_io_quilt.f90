...
real , DIMENSION(max_domains) :: bioemdt
real , DIMENSION(max_domains) :: photdt
real , DIMENSION(max_domains) :: chemdt
integer :: ne_area
integer :: kemit
integer :: nmegan
integer :: kfuture
...
integer :: ndepvel
integer :: kdepvel
integer , DIMENSION(max_domains) :: biomass_emiss_opt
integer :: cam_mam_mode
integer :: cam_mam_nspec
logical :: cam_mp_mam_cpled
integer :: mozart_ph_diag
character*256 , DIMENSION(max_mgnspc) :: megan_specifier
character*256 :: megan_factors_file
logical :: megan_mapped_emisfctrs
character*256 , DIMENSION(max_domains) :: vprm_opt
real :: wpeat
real :: wflood
character*256 , DIMENSION(max_domains) :: term_opt
logical :: do_pvozone
integer , DIMENSION(max_domains) :: chem_conv_tr
integer , DIMENSION(max_domains) :: conv_tr_wetscav
integer , DIMENSION(max_domains) :: conv_tr_aqchem
integer , DIMENSION(max_domains) :: chem_opt
integer , DIMENSION(max_domains) :: gaschem_onoff
integer , DIMENSION(max_domains) :: aerchem_onoff
integer , DIMENSION(max_domains) :: wetscav_onoff
integer , DIMENSION(max_domains) :: dustwd_onoff
integer , DIMENSION(max_domains) :: cldchem_onoff
logical , DIMENSION(max_domains) :: is_full_tuv
real , DIMENSION(max_domains) :: lambda_cutoff
integer , DIMENSION(max_domains) :: cld_od_opt
integer , DIMENSION(max_domains) :: pht_cldfrc_opt
logical , DIMENSION(max_domains) :: phot_blcld
integer , DIMENSION(max_domains) :: vertmix_onoff
integer , DIMENSION(max_domains) :: chem_in_opt
integer , DIMENSION(max_domains) :: phot_opt
integer , DIMENSION(max_domains) :: gas_drydep_opt
integer , DIMENSION(max_domains) :: aer_drydep_opt
integer , DIMENSION(max_domains) :: diagnostic_chem
integer , DIMENSION(max_domains) :: aero_diag_opt
integer , DIMENSION(max_domains) :: aero_cw_diag_opt
integer , DIMENSION(max_domains) :: kfcup_diag
integer , DIMENSION(max_domains) :: aer_aerodynres_opt
integer , DIMENSION(max_domains) :: emiss_opt
integer , DIMENSION(max_domains) :: emiss_opt_vol
integer :: dust_opt
integer :: dust_schme
integer :: dmsemis_opt
integer :: seas_opt
integer , DIMENSION(max_domains) :: bio_emiss_opt
integer , DIMENSION(max_domains) :: biomass_burn_opt
integer , DIMENSION(max_domains) :: plumerisefire_frq
integer , DIMENSION(max_domains) :: emiss_inpt_opt
integer , DIMENSION(max_domains) :: gas_bc_opt
integer , DIMENSION(max_domains) :: gas_ic_opt
integer , DIMENSION(max_domains) :: aer_bc_opt
integer , DIMENSION(max_domains) :: aer_ic_opt
logical , DIMENSION(max_domains) :: have_bcs_chem
logical , DIMENSION(max_domains) :: have_bcs_tracer
logical , DIMENSION(max_domains) :: scale_fire_emiss
integer , DIMENSION(max_domains) :: aer_ra_feedback
integer , DIMENSION(max_domains) :: aer_op_opt
integer :: opt_pars_out
integer , DIMENSION(max_domains) :: diagnostic_dep
integer , DIMENSION(max_domains) :: aircraft_emiss_opt
logical , DIMENSION(max_domains) :: have_bcs_upper
real , DIMENSION(max_domains) :: fixed_ubc_press
character*256 :: fixed_ubc_inname
character*256 :: trop_lev_inname
character*256 , DIMENSION(max_domains) :: exo_coldens_inname
character*256 , DIMENSION(max_domains) :: wes_seasonal_inname
integer , DIMENSION(max_domains) :: chemdiag
integer , DIMENSION(max_domains) :: aero_srf_area_diag
real :: dust_alpha
real :: dust_gamma
real :: dust_smtune
real :: dust_ustune
...
integer :: dust_smois
real :: emiss_ash_hgt
real , DIMENSION(max_domains) :: depo_fact
integer :: track_chem_num
character*256 , DIMENSION(max_trackchem) :: track_chem_name
integer :: track_rad_num
integer :: track_tuv_num
integer :: track_tuv_lev
integer :: n2o5_hetchem
integer :: mosaic_aerchem_optaa
real , DIMENSION(max_domains) :: af_lambda_start
real , DIMENSION(max_domains) :: af_lambda_end
logical :: do_isorropia
real , DIMENSION(max_domains) :: n_ic
real , DIMENSION(max_domains) :: n_cg
integer , DIMENSION(max_domains) :: lnox_opt
logical , DIMENSION(max_domains) :: lnox_passive
real , DIMENSION(max_domains) :: ltng_temp_upper
real , DIMENSION(max_domains) :: ltng_temp_lower
logical :: has_o3_exo_coldens
real :: du_at_grnd
logical :: scale_o3_to_grnd_exo_coldens
logical :: scale_o3_to_du_at_grnd
integer , DIMENSION(max_domains) :: irr_opt
...
NAMELIST /chem/ gsfcrad_gocart_coupling
NAMELIST /chem/ gsfcgce_gocart_coupling
NAMELIST /time_control/ auxinput12_inname
NAMELIST /time_control/ io_form_auxinput12
NAMELIST /chem/ emi_inname
NAMELIST /chem/ fireemi_inname
NAMELIST /chem/ input_chem_inname
NAMELIST /chem/ emi_outname
NAMELIST /chem/ fireemi_outname
NAMELIST /chem/ input_chem_outname
NAMELIST /chem/ io_style_emissions
NAMELIST /chem/ bioemdt
NAMELIST /chem/ photdt
NAMELIST /chem/ chemdt
NAMELIST /chem/ ne_area
NAMELIST /chem/ kemit
NAMELIST /chem/ nmegan
NAMELIST /chem/ kfuture
NAMELIST /chem/ kfire
NAMELIST /chem/ kemit_aircraft
NAMELIST /chem/ kdvel
NAMELIST /chem/ ndepvel
NAMELIST /chem/ kdepvel
NAMELIST /chem/ biomass_emiss_opt
NAMELIST /chem/ cam_mam_mode
NAMELIST /chem/ cam_mam_nspec
NAMELIST /chem/ cam_mp_mam_cpled
NAMELIST /chem/ mozart_ph_diag
NAMELIST /physics/ megan_specifier
NAMELIST /physics/ megan_factors_file
NAMELIST /physics/ megan_mapped_emisfctrs
NAMELIST /chem/ vprm_opt
NAMELIST /chem/ wpeat
NAMELIST /chem/ wflood
NAMELIST /chem/ term_opt
NAMELIST /chem/ do_pvozone
NAMELIST /chem/ chem_conv_tr
NAMELIST /chem/ conv_tr_wetscav
NAMELIST /chem/ conv_tr_aqchem
NAMELIST /chem/ chem_opt
NAMELIST /chem/ gaschem_onoff
NAMELIST /chem/ aerchem_onoff
NAMELIST /chem/ wetscav_onoff
NAMELIST /chem/ dustwd_onoff
NAMELIST /chem/ cldchem_onoff
NAMELIST /chem/ is_full_tuv
NAMELIST /chem/ lambda_cutoff
NAMELIST /chem/ cld_od_opt
NAMELIST /chem/ pht_cldfrc_opt
NAMELIST /chem/ phot_blcld
NAMELIST /chem/ vertmix_onoff
NAMELIST /chem/ chem_in_opt
NAMELIST /chem/ phot_opt
NAMELIST /chem/ gas_drydep_opt
NAMELIST /chem/ aer_drydep_opt
NAMELIST /chem/ diagnostic_chem
NAMELIST /chem/ aero_diag_opt
NAMELIST /chem/ aero_cw_diag_opt
NAMELIST /chem/ kfcup_diag
NAMELIST /chem/ aer_aerodynres_opt
NAMELIST /chem/ emiss_opt
NAMELIST /chem/ emiss_opt_vol
NAMELIST /chem/ dust_opt
NAMELIST /chem/ dust_schme
NAMELIST /chem/ dmsemis_opt
NAMELIST /chem/ seas_opt
NAMELIST /chem/ bio_emiss_opt
NAMELIST /chem/ biomass_burn_opt
NAMELIST /chem/ plumerisefire_frq
NAMELIST /chem/ emiss_inpt_opt
NAMELIST /chem/ gas_bc_opt
NAMELIST /chem/ gas_ic_opt
NAMELIST /chem/ aer_bc_opt
NAMELIST /chem/ aer_ic_opt
NAMELIST /chem/ have_bcs_chem
NAMELIST /chem/ have_bcs_tracer
NAMELIST /chem/ scale_fire_emiss
NAMELIST /chem/ aer_ra_feedback
NAMELIST /chem/ aer_op_opt
NAMELIST /chem/ opt_pars_out
NAMELIST /chem/ diagnostic_dep
NAMELIST /chem/ aircraft_emiss_opt
NAMELIST /chem/ have_bcs_upper
NAMELIST /chem/ fixed_ubc_press
NAMELIST /chem/ fixed_ubc_inname
NAMELIST /chem/ trop_lev_inname
NAMELIST /chem/ exo_coldens_inname
NAMELIST /chem/ wes_seasonal_inname
NAMELIST /chem/ chemdiag
NAMELIST /chem/ aero_srf_area_diag
NAMELIST /chem/ dust_alpha
NAMELIST /chem/ dust_gamma
NAMELIST /chem/ dust_smtune
NAMELIST /chem/ dust_ustune
NAMELIST /chem/ dust_dsr
NAMELIST /chem/ dust_veg
NAMELIST /chem/ dust_soils
NAMELIST /chem/ dust_smois
NAMELIST /chem/ emiss_ash_hgt
NAMELIST /chem/ depo_fact
NAMELIST /chem/ track_chem_num
NAMELIST /chem/ track_chem_name
NAMELIST /chem/ track_rad_num
NAMELIST /chem/ track_tuv_num
NAMELIST /chem/ track_tuv_lev
NAMELIST /chem/ n2o5_hetchem
NAMELIST /chem/ mosaic_aerchem_optaa
NAMELIST /chem/ af_lambda_start
NAMELIST /chem/ af_lambda_end
NAMELIST /chem/ do_isorropia
NAMELIST /chem/ n_ic
NAMELIST /chem/ n_cg
NAMELIST /chem/ lnox_opt
NAMELIST /chem/ lnox_passive
NAMELIST /physics/ ltng_temp_upper
NAMELIST /physics/ ltng_temp_lower
NAMELIST /chem/ has_o3_exo_coldens
NAMELIST /chem/ du_at_grnd
NAMELIST /chem/ scale_o3_to_grnd_exo_coldens
NAMELIST /chem/ scale_o3_to_du_at_grnd
NAMELIST /chem/ irr_opt
NAMELIST /domains/ num_gca_levels
NAMELIST /domains/ gca_input_opt
