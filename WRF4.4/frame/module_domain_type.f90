...
integer                                  :: gsfcrad_gocart_coupling
integer                                  :: gsfcgce_gocart_coupling
...
integer                                  :: mozart_ph_diag
character*256                               :: megan_specifier
character*256                               :: megan_factors_file
logical                                  :: megan_mapped_emisfctrs
...
integer                                  :: dustwd_onoff
integer                                  :: cldchem_onoff
logical                                  :: is_full_tuv
real                                     :: lambda_cutoff
integer                                  :: cld_od_opt
integer                                  :: pht_cldfrc_opt
logical                                  :: phot_blcld
...
integer                                  :: aero_diag_opt
integer                                  :: aero_cw_diag_opt
integer                                  :: kfcup_diag
...
integer                                  :: mosaic_aerchem_optaa
real                                     :: af_lambda_start
real                                     :: af_lambda_end
...
logical                                  :: has_o3_exo_coldens
real                                     :: du_at_grnd
logical                                  :: scale_o3_to_grnd_exo_coldens
logical                                  :: scale_o3_to_du_at_grnd
integer                                  :: irr_opt
integer                                  :: num_gca_levels
integer                                  :: gca_input_opt
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: aod_out
real      ,DIMENSION(:,:)     ,POINTER   :: aod2d_out
real      ,DIMENSION(:,:)     ,POINTER   :: atop2d_out
real      ,DIMENSION(:,:,:)   ,POINTER   :: icn_diag
real      ,DIMENSION(:,:,:)   ,POINTER   :: nc_diag
real      ,DIMENSION(:,:,:)   ,POINTER   :: cldfra2
real      ,DIMENSION(:,:,:)   ,POINTER   :: qv_b4mp
real      ,DIMENSION(:,:,:)   ,POINTER   :: qc_b4mp
real      ,DIMENSION(:,:,:)   ,POINTER   :: qi_b4mp
real      ,DIMENSION(:,:,:)   ,POINTER   :: qs_b4mp
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_cw
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_aer01
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_aer02
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_aer03
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_aer04
real      ,DIMENSION(:,:,:)   ,POINTER   :: ccn1
real      ,DIMENSION(:,:,:)   ,POINTER   :: ccn2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ccn3
real      ,DIMENSION(:,:,:)   ,POINTER   :: ccn4
real      ,DIMENSION(:,:,:)   ,POINTER   :: ccn5
real      ,DIMENSION(:,:,:)   ,POINTER   :: ccn6
real      ,DIMENSION(:,:,:)   ,POINTER   :: qlsink
real      ,DIMENSION(:,:,:)   ,POINTER   :: precr
real      ,DIMENSION(:,:,:)   ,POINTER   :: preci
real      ,DIMENSION(:,:,:)   ,POINTER   :: precs
real      ,DIMENSION(:,:,:)   ,POINTER   :: precg
real      ,DIMENSION(:,:,:,:) ,POINTER   :: wetscav_frcing
real      ,DIMENSION(:,:,:,:) ,POINTER   :: emis_ant
real      ,DIMENSION(:,:)     ,POINTER   :: ust_t
real      ,DIMENSION(:,:)     ,POINTER   :: rough_cor
real      ,DIMENSION(:,:)     ,POINTER   :: smois_cor
real      ,DIMENSION(:,:)     ,POINTER   :: dustload_1
real      ,DIMENSION(:,:)     ,POINTER   :: dustload_2
real      ,DIMENSION(:,:)     ,POINTER   :: dustload_3
real      ,DIMENSION(:,:)     ,POINTER   :: dustload_4
real      ,DIMENSION(:,:)     ,POINTER   :: dustload_5
real      ,DIMENSION(:,:)     ,POINTER   :: depvelocity
real      ,DIMENSION(:,:)     ,POINTER   :: setvel_1
real      ,DIMENSION(:,:)     ,POINTER   :: setvel_2
real      ,DIMENSION(:,:)     ,POINTER   :: setvel_3
real      ,DIMENSION(:,:)     ,POINTER   :: setvel_4
real      ,DIMENSION(:,:)     ,POINTER   :: setvel_5
real      ,DIMENSION(:,:)     ,POINTER   :: dustgraset_1
real      ,DIMENSION(:,:)     ,POINTER   :: dustgraset_2
real      ,DIMENSION(:,:)     ,POINTER   :: dustgraset_3
real      ,DIMENSION(:,:)     ,POINTER   :: dustgraset_4
real      ,DIMENSION(:,:)     ,POINTER   :: dustgraset_5
real      ,DIMENSION(:,:)     ,POINTER   :: dustdrydep_1
real      ,DIMENSION(:,:)     ,POINTER   :: dustdrydep_2
real      ,DIMENSION(:,:)     ,POINTER   :: dustdrydep_3
real      ,DIMENSION(:,:)     ,POINTER   :: dustdrydep_4
real      ,DIMENSION(:,:)     ,POINTER   :: dustdrydep_5
real      ,DIMENSION(:,:,:)   ,POINTER   :: dustwd_1
real      ,DIMENSION(:,:,:)   ,POINTER   :: dustwd_2
real      ,DIMENSION(:,:,:)   ,POINTER   :: dustwd_3
real      ,DIMENSION(:,:,:)   ,POINTER   :: dustwd_4
real      ,DIMENSION(:,:,:)   ,POINTER   :: dustwd_5
real      ,DIMENSION(:,:)     ,POINTER   :: wetdep_1
real      ,DIMENSION(:,:)     ,POINTER   :: wetdep_2
real      ,DIMENSION(:,:)     ,POINTER   :: wetdep_3
real      ,DIMENSION(:,:)     ,POINTER   :: wetdep_4
real      ,DIMENSION(:,:)     ,POINTER   :: wetdep_5
real      ,DIMENSION(:,:)     ,POINTER   :: dustwdload_1
real      ,DIMENSION(:,:)     ,POINTER   :: dustwdload_2
real      ,DIMENSION(:,:)     ,POINTER   :: dustwdload_3
real      ,DIMENSION(:,:)     ,POINTER   :: dustwdload_4
real      ,DIMENSION(:,:)     ,POINTER   :: dustwdload_5
real      ,DIMENSION(:,:,:,:) ,POINTER   :: eghg_bio
real      ,DIMENSION(:,:,:,:) ,POINTER   :: emis_dust
real      ,DIMENSION(:,:,:,:) ,POINTER   :: emis_seas
real      ,DIMENSION(:,:,:,:) ,POINTER   :: emis_seas2
real      ,DIMENSION(:,:,:,:) ,POINTER   :: emis_vol
real      ,DIMENSION(:,:,:,:) ,POINTER   :: ebu
real      ,DIMENSION(:,:,:,:) ,POINTER   :: ebu_in
real      ,DIMENSION(:,:)     ,POINTER   :: mean_fct_agtf
real      ,DIMENSION(:,:)     ,POINTER   :: mean_fct_agef
real      ,DIMENSION(:,:)     ,POINTER   :: mean_fct_agsv
real      ,DIMENSION(:,:)     ,POINTER   :: mean_fct_aggr
real      ,DIMENSION(:,:)     ,POINTER   :: firesize_agtf
real      ,DIMENSION(:,:)     ,POINTER   :: firesize_agef
real      ,DIMENSION(:,:)     ,POINTER   :: firesize_agsv
real      ,DIMENSION(:,:)     ,POINTER   :: firesize_aggr
real      ,DIMENSION(:,:,:,:) ,POINTER   :: radfld
real      ,DIMENSION(:,:,:,:) ,POINTER   :: adjcoe
real      ,DIMENSION(:,:,:,:) ,POINTER   :: phrate
real      ,DIMENSION(:,:,:)   ,POINTER   :: track_chem
real      ,DIMENSION(:,:)     ,POINTER   :: track_o31d
real      ,DIMENSION(:,:)     ,POINTER   :: track_o33p
real      ,DIMENSION(:,:)     ,POINTER   :: track_no2
real      ,DIMENSION(:,:)     ,POINTER   :: track_hno2
real      ,DIMENSION(:,:)     ,POINTER   :: track_hno3
real      ,DIMENSION(:,:)     ,POINTER   :: track_h2o2
real      ,DIMENSION(:,:)     ,POINTER   :: track_ch3o2h
real      ,DIMENSION(:,:,:)   ,POINTER   :: track_radfld
real      ,DIMENSION(:,:,:)   ,POINTER   :: track_adjcoe
real      ,DIMENSION(:,:,:)   ,POINTER   :: track_phrate
real      ,DIMENSION(:)       ,POINTER   :: track_wc
real      ,DIMENSION(:)       ,POINTER   :: track_zref
real      ,DIMENSION(:,:)     ,POINTER   :: tropo_p
real      ,DIMENSION(:,:)     ,POINTER   :: tropo_z
integer   ,DIMENSION(:,:)     ,POINTER   :: tropo_lev
real      ,DIMENSION(:,:)     ,POINTER   :: hno3_col_mdel
real      ,DIMENSION(:,:,:,:) ,POINTER   :: emis_aircraft
real      ,DIMENSION(:,:,:,:) ,POINTER   :: ext_coef
real      ,DIMENSION(:,:,:,:) ,POINTER   :: bscat_coef
real      ,DIMENSION(:,:,:,:) ,POINTER   :: asym_par
real      ,DIMENSION(:,:,:)   ,POINTER   :: ddlen
real      ,DIMENSION(:,:,:)   ,POINTER   :: ddflx
real      ,DIMENSION(:,:,:)   ,POINTER   :: wdflx
real      ,DIMENSION(:,:,:)   ,POINTER   :: e_bio
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_iso
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_oli
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_api
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_lim
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_xyl
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_hc3
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_ete
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_olt
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_ket
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_ald
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_hcho
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_eth
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_ora2
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_co
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_nr
real      ,DIMENSION(:,:)     ,POINTER   :: noag_grow
real      ,DIMENSION(:,:)     ,POINTER   :: noag_nongrow
real      ,DIMENSION(:,:)     ,POINTER   :: nononag
real      ,DIMENSION(:,:)     ,POINTER   :: slai
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_iso
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_oli
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_api
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_lim
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_xyl
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_hc3
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ete
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_olt
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ket
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ald
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_hcho
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_eth
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ora2
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_co
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_nr
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_no
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_alk3
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_alk4
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_alk5
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ole1
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ole2
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_aro1
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_aro2
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ccho
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_meoh
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ethene
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_hcooh
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_terp
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_bald
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_cco_oh
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_rco_oh
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_c10h16
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_tol
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_bigalk
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_bigene
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ch3oh
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_acet
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_nh3
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_no2
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_c2h5oh
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ch3cooh
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_mek
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_c2h6
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_c2h4
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_c3h6
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_c3h8
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_so2
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_dms
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_myrc
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_bpi
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_hcn
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_c5h8
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_apinene
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_bpinene
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_toluene
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ch3cho
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_ch3co2h
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_tbut2ene
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_c2h5cho
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_nc4h10
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_co2oce
real      ,DIMENSION(:,:)     ,POINTER   :: dust_flux
real      ,DIMENSION(:,:)     ,POINTER   :: seas_flux
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_sesq
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_sesq
real      ,DIMENSION(:,:)     ,POINTER   :: sebio_mbo
real      ,DIMENSION(:,:)     ,POINTER   :: ebio_mbo
real      ,DIMENSION(:,:)     ,POINTER   :: mebio_isop
real      ,DIMENSION(:,:)     ,POINTER   :: mebio_apin
real      ,DIMENSION(:,:)     ,POINTER   :: mebio_bpin
real      ,DIMENSION(:,:)     ,POINTER   :: mebio_bcar
real      ,DIMENSION(:,:)     ,POINTER   :: mebio_acet
real      ,DIMENSION(:,:)     ,POINTER   :: mebio_mbo
real      ,DIMENSION(:,:)     ,POINTER   :: mebio_no
real      ,DIMENSION(:,:)     ,POINTER   :: msebio_isop
real      ,DIMENSION(:,:,:)   ,POINTER   :: mlai
real      ,DIMENSION(:,:)     ,POINTER   :: pftp_bt
real      ,DIMENSION(:,:)     ,POINTER   :: pftp_nt
real      ,DIMENSION(:,:)     ,POINTER   :: pftp_sb
real      ,DIMENSION(:,:)     ,POINTER   :: pftp_hb
real      ,DIMENSION(:,:,:)   ,POINTER   :: mtsa
real      ,DIMENSION(:,:,:)   ,POINTER   :: mswdown
real      ,DIMENSION(:,:,:)   ,POINTER   :: efmegan
real      ,DIMENSION(:,:,:)   ,POINTER   :: backg_oh
real      ,DIMENSION(:,:,:)   ,POINTER   :: backg_h2o2
real      ,DIMENSION(:,:,:)   ,POINTER   :: backg_no3
real      ,DIMENSION(:,:,:)   ,POINTER   :: erod_dri
real      ,DIMENSION(:,:)     ,POINTER   :: lai_vegmask
real      ,DIMENSION(:,:,:)   ,POINTER   :: lai_veg_8day
real      ,DIMENSION(:,:)     ,POINTER   :: clayfrac
real      ,DIMENSION(:,:)     ,POINTER   :: sandfrac
real      ,DIMENSION(:,:)     ,POINTER   :: clayfrac_nga
real      ,DIMENSION(:,:)     ,POINTER   :: sandfrac_nga
real      ,DIMENSION(:,:)     ,POINTER   :: afwa_dustloft
real      ,DIMENSION(:,:,:)   ,POINTER   :: tot_dust
real      ,DIMENSION(:,:)     ,POINTER   :: tot_edust
real      ,DIMENSION(:,:,:)   ,POINTER   :: vis_dust
real      ,DIMENSION(:,:,:)   ,POINTER   :: br_rto
real      ,DIMENSION(:,:)     ,POINTER   :: ash_fall
real      ,DIMENSION(:,:)     ,POINTER   :: erup_beg
real      ,DIMENSION(:,:)     ,POINTER   :: erup_end
real      ,DIMENSION(:,:)     ,POINTER   :: dep_vel_o3
real      ,DIMENSION(:,:,:)   ,POINTER   :: cu_co_ten
real      ,DIMENSION(:,:,:,:) ,POINTER   :: conv_ct
real      ,DIMENSION(:,:,:,:) ,POINTER   :: chem_ct
real      ,DIMENSION(:,:,:,:) ,POINTER   :: vmix_ct
real      ,DIMENSION(:,:,:,:) ,POINTER   :: advh_ct
real      ,DIMENSION(:,:,:,:) ,POINTER   :: advz_ct
real      ,DIMENSION(:,:,:,:) ,POINTER   :: dvel
real      ,DIMENSION(:,:,:,:) ,POINTER   :: aero_srf_area
real      ,DIMENSION(:,:,:,:) ,POINTER   :: dep_vel
real      ,DIMENSION(:,:)     ,POINTER   :: wd_so4_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_no3_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_nh4_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_oa_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_so2_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_sulf_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_hno3_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_nh3_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_asoa_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_bsoa_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_cvasoa_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_cvbsoa_sc
real      ,DIMENSION(:,:)     ,POINTER   :: wd_so4_cu
real      ,DIMENSION(:,:)     ,POINTER   :: wd_no3_cu
real      ,DIMENSION(:,:)     ,POINTER   :: wd_nh4_cu
real      ,DIMENSION(:,:)     ,POINTER   :: wd_oa_cu
real      ,DIMENSION(:,:)     ,POINTER   :: wd_so2_cu
real      ,DIMENSION(:,:)     ,POINTER   :: wd_sulf_cu
real      ,DIMENSION(:,:)     ,POINTER   :: wd_hno3_cu
real      ,DIMENSION(:,:)     ,POINTER   :: wd_nh3_cu
real      ,DIMENSION(:,:)     ,POINTER   :: wd_asoa_cu
real      ,DIMENSION(:,:)     ,POINTER   :: wd_bsoa_cu
real      ,DIMENSION(:,:)     ,POINTER   :: wd_cvasoa_cu
real      ,DIMENSION(:,:)     ,POINTER   :: wd_cvbsoa_cu
real      ,DIMENSION(:,:,:)   ,POINTER   :: aerwrf
real      ,DIMENSION(:,:,:)   ,POINTER   :: pm2_5_dry
real      ,DIMENSION(:,:,:)   ,POINTER   :: pm2_5_dry_ec
real      ,DIMENSION(:,:,:)   ,POINTER   :: pm2_5_water
real      ,DIMENSION(:,:,:)   ,POINTER   :: pm10
real      ,DIMENSION(:,:)     ,POINTER   :: uvrad
real      ,DIMENSION(:,:)     ,POINTER   :: tcosz
real      ,DIMENSION(:,:)     ,POINTER   :: ttday
real      ,DIMENSION(:,:,:)   ,POINTER   :: tsoa
real      ,DIMENSION(:,:,:)   ,POINTER   :: bsoa
real      ,DIMENSION(:,:,:)   ,POINTER   :: asoa
real      ,DIMENSION(:,:)     ,POINTER   :: dms_0
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_a01
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_a02
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_a03
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_a04
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_a05
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_a06
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_a07
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_a08
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_a01
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_a02
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_a03
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_a04
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_a05
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_a06
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_a07
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_a08
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_a01
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_a02
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_a03
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_a04
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_a05
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_a06
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_a07
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_a08
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_a01
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_a02
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_a03
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_a04
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_a05
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_a06
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_a07
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_a08
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_a01
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_a02
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_a03
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_a04
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_a05
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_a06
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_a07
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_a08
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_a01
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_a02
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_a03
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_a04
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_a05
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_a06
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_a07
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_a08
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_a01
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_a02
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_a03
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_a04
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_a05
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_a06
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_a07
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_a08
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_a01
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_a02
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_a03
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_a04
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_a05
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_a06
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_a07
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_a08
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_c
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_o
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_c
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_o
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_v1
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_v2
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_v3
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_v4
real      ,DIMENSION(:,:,:)   ,POINTER   :: ant_v1
real      ,DIMENSION(:,:,:)   ,POINTER   :: ant_v2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ant_v3
real      ,DIMENSION(:,:,:)   ,POINTER   :: ant_v4
integer   ,DIMENSION(:)       ,POINTER   :: vbs_nbin
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_cw01
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_cw02
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_cw03
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_cw04
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_cw05
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_cw06
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_cw07
real      ,DIMENSION(:,:,:)   ,POINTER   :: hoa_cw08
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_cw01
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_cw02
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_cw03
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_cw04
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_cw05
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_cw06
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_cw07
real      ,DIMENSION(:,:,:)   ,POINTER   :: soa_cw08
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_cw01
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_cw02
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_cw03
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_cw04
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_cw05
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_cw06
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_cw07
real      ,DIMENSION(:,:,:)   ,POINTER   :: bboa_cw08
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_cw01
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_cw02
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_cw03
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_cw04
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_cw05
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_cw06
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_cw07
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_cw08
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_cw01
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_cw02
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_cw03
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_cw04
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_cw05
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_cw06
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_cw07
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_cw08
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_cw01
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_cw02
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_cw03
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_cw04
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_cw05
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_cw06
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_cw07
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_cw08
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_cw01
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_cw02
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_cw03
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_cw04
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_cw05
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_cw06
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_cw07
real      ,DIMENSION(:,:,:)   ,POINTER   :: arosoa_cw08
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_cw01
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_cw02
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_cw03
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_cw04
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_cw05
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_cw06
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_cw07
real      ,DIMENSION(:,:,:)   ,POINTER   :: totoa_cw08
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_cw_c
real      ,DIMENSION(:,:,:)   ,POINTER   :: hsoa_cw_o
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_cw_c
real      ,DIMENSION(:,:,:)   ,POINTER   :: bbsoa_cw_o
real      ,DIMENSION(:,:,:)   ,POINTER   :: ant_cw_v1
real      ,DIMENSION(:,:,:)   ,POINTER   :: biog_cw_v1
real      ,DIMENSION(:,:,:)   ,POINTER   :: smpa_v1
real      ,DIMENSION(:,:,:)   ,POINTER   :: smpbb_v1
real      ,DIMENSION(:,:,:)   ,POINTER   :: asmpsoa_a01
real      ,DIMENSION(:,:,:)   ,POINTER   :: asmpsoa_a02
real      ,DIMENSION(:,:,:)   ,POINTER   :: asmpsoa_a03
real      ,DIMENSION(:,:,:)   ,POINTER   :: asmpsoa_a04
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_o31d
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_o33p
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_no2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_no3o2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_no3o
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_hno2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_hno3
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_hno4
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_h2o2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_ch2or
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_ch2om
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_ch3cho
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_ch3coch3
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_ch3coc2h5
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_hcocho
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_ch3cocho
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_hcochest
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_ch3o2h
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_ch3coo2h
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_ch3ono2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_hcochob
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_macr
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_n2o5
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_o2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_pan
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_acet
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_mglo
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_hno4_2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_clno2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_n2o
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_pooh
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_mpan
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_mvk
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_etooh
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_prooh
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_onitr
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_acetol
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_glyald
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_hyac
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_mek
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_open
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_gly
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_acetp
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_xooh
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_isooh
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_alkooh
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_mekooh
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_tolooh
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_terpooh
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_cl2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_hocl
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_fmcl
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_par
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_erythema
real      ,DIMENSION(:,:,:)   ,POINTER   :: af_dir
real      ,DIMENSION(:,:,:)   ,POINTER   :: af_up
real      ,DIMENSION(:,:,:)   ,POINTER   :: af_dn
real      ,DIMENSION(:,:,:)   ,POINTER   :: dt_cld
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw1
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw2
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw3
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw4
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw5
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw6
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw7
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw8
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw9
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw10
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw11
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw12
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw13
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw14
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw15
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaerlw16
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw1
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw2
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw3
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw4
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw5
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw6
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw7
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw8
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw9
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw10
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw11
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw12
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw13
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw14
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw15
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaerlw16
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaer1
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaer2
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaer3
real      ,DIMENSION(:,:,:)   ,POINTER   :: extaer4
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaer1
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaer2
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaer3
real      ,DIMENSION(:,:,:)   ,POINTER   :: tauaer4
real      ,DIMENSION(:,:,:)   ,POINTER   :: gaer1
real      ,DIMENSION(:,:,:)   ,POINTER   :: gaer2
real      ,DIMENSION(:,:,:)   ,POINTER   :: gaer3
real      ,DIMENSION(:,:,:)   ,POINTER   :: gaer4
real      ,DIMENSION(:,:,:)   ,POINTER   :: waer1
real      ,DIMENSION(:,:,:)   ,POINTER   :: waer2
real      ,DIMENSION(:,:,:)   ,POINTER   :: waer3
real      ,DIMENSION(:,:,:)   ,POINTER   :: waer4
real      ,DIMENSION(:,:,:)   ,POINTER   :: bscoef1
real      ,DIMENSION(:,:,:)   ,POINTER   :: bscoef2
real      ,DIMENSION(:,:,:)   ,POINTER   :: bscoef3
real      ,DIMENSION(:,:,:)   ,POINTER   :: bscoef4
real      ,DIMENSION(:,:,:,:) ,POINTER   :: l2aer
real      ,DIMENSION(:,:,:,:) ,POINTER   :: l3aer
real      ,DIMENSION(:,:,:,:) ,POINTER   :: l4aer
real      ,DIMENSION(:,:,:,:) ,POINTER   :: l5aer
real      ,DIMENSION(:,:,:,:) ,POINTER   :: l6aer
real      ,DIMENSION(:,:,:,:) ,POINTER   :: l7aer
integer   ,DIMENSION(:,:,:)   ,POINTER   :: chem_cupflag
real      ,DIMENSION(:,:,:)   ,POINTER   :: co_a_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: hno3_a_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: so4_a_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: so4_cw_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: nh4_a_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: nh4_cw_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_a_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_cw_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: oa_a_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: oa_cw_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: oin_a_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: oin_cw_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: bc_a_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: bc_cw_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: na_a_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: na_cw_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: cl_a_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: cl_cw_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: so4_a_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: so4_cw_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: nh4_a_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: nh4_cw_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_a_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_cw_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: oa_a_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: oa_cw_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: oin_a_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: oin_cw_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: bc_a_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: bc_cw_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: na_a_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: na_cw_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: cl_a_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: cl_cw_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: water_1to4_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: water_5to6_ic_cup
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2oaj
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2oai
real      ,DIMENSION(:,:,:)   ,POINTER   :: nu3
real      ,DIMENSION(:,:,:)   ,POINTER   :: ac3
real      ,DIMENSION(:,:,:)   ,POINTER   :: cor3
real      ,DIMENSION(:,:,:)   ,POINTER   :: asulf
real      ,DIMENSION(:,:,:)   ,POINTER   :: ahno3
real      ,DIMENSION(:,:,:)   ,POINTER   :: anh3
real      ,DIMENSION(:,:,:)   ,POINTER   :: cvaro1
real      ,DIMENSION(:,:,:)   ,POINTER   :: cvaro2
real      ,DIMENSION(:,:,:)   ,POINTER   :: cvalk1
real      ,DIMENSION(:,:,:)   ,POINTER   :: cvole1
real      ,DIMENSION(:,:,:)   ,POINTER   :: cvapi1
real      ,DIMENSION(:,:,:)   ,POINTER   :: cvapi2
real      ,DIMENSION(:,:,:)   ,POINTER   :: cvlim1
real      ,DIMENSION(:,:,:)   ,POINTER   :: cvlim2
real      ,DIMENSION(:,:,:)   ,POINTER   :: snu
real      ,DIMENSION(:,:,:)   ,POINTER   :: sac
real      ,DIMENSION(:,:,:)   ,POINTER   :: addt
real      ,DIMENSION(:,:,:)   ,POINTER   :: addx
real      ,DIMENSION(:,:,:)   ,POINTER   :: addc
real      ,DIMENSION(:,:,:)   ,POINTER   :: etep
real      ,DIMENSION(:,:,:)   ,POINTER   :: oltp
real      ,DIMENSION(:,:,:)   ,POINTER   :: olip
real      ,DIMENSION(:,:,:)   ,POINTER   :: cslp
real      ,DIMENSION(:,:,:)   ,POINTER   :: limp
real      ,DIMENSION(:,:,:)   ,POINTER   :: hc5p
real      ,DIMENSION(:,:,:)   ,POINTER   :: hc8p
real      ,DIMENSION(:,:,:)   ,POINTER   :: tolp
real      ,DIMENSION(:,:,:)   ,POINTER   :: xylp
real      ,DIMENSION(:,:,:)   ,POINTER   :: apip
real      ,DIMENSION(:,:,:)   ,POINTER   :: isop
real      ,DIMENSION(:,:,:)   ,POINTER   :: hc3p
real      ,DIMENSION(:,:,:)   ,POINTER   :: ethp
real      ,DIMENSION(:,:,:)   ,POINTER   :: o3p
real      ,DIMENSION(:,:,:)   ,POINTER   :: tco3
real      ,DIMENSION(:,:,:)   ,POINTER   :: mo2
real      ,DIMENSION(:,:,:)   ,POINTER   :: o1d
real      ,DIMENSION(:,:,:)   ,POINTER   :: olnn
real      ,DIMENSION(:,:,:)   ,POINTER   :: olnd
real      ,DIMENSION(:,:,:)   ,POINTER   :: rpho
real      ,DIMENSION(:,:,:)   ,POINTER   :: xo2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ketp
real      ,DIMENSION(:,:,:)   ,POINTER   :: xno2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ol2p
real      ,DIMENSION(:,:,:)   ,POINTER   :: oln
real      ,DIMENSION(:,:,:)   ,POINTER   :: macp
real      ,DIMENSION(:,:,:)   ,POINTER   :: hocoo
real      ,DIMENSION(:,:,:)   ,POINTER   :: bzno2_o
real      ,DIMENSION(:,:,:)   ,POINTER   :: bz_o
real      ,DIMENSION(:,:,:)   ,POINTER   :: tbu_o
real      ,DIMENSION(:,:,:,:) ,POINTER   :: vprm_in
real      ,DIMENSION(:)       ,POINTER   :: rad_vprm
real      ,DIMENSION(:)       ,POINTER   :: lambda_vprm
real      ,DIMENSION(:)       ,POINTER   :: alpha_vprm
real      ,DIMENSION(:)       ,POINTER   :: resp_vprm
real      ,DIMENSION(:,:,:,:) ,POINTER   :: wet_in
real      ,DIMENSION(:)       ,POINTER   :: biomt_par
real      ,DIMENSION(:)       ,POINTER   :: emit_par
real      ,DIMENSION(:,:,:,:) ,POINTER   :: chem
real      ,DIMENSION(:,:,:,:) ,POINTER   :: chem_bxs
real      ,DIMENSION(:,:,:,:) ,POINTER   :: chem_bxe
real      ,DIMENSION(:,:,:,:) ,POINTER   :: chem_bys
real      ,DIMENSION(:,:,:,:) ,POINTER   :: chem_bye
real      ,DIMENSION(:,:,:,:) ,POINTER   :: chem_btxs
real      ,DIMENSION(:,:,:,:) ,POINTER   :: chem_btxe
real      ,DIMENSION(:,:,:,:) ,POINTER   :: chem_btys
real      ,DIMENSION(:,:,:,:) ,POINTER   :: chem_btye
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: gamn2o5
real      ,DIMENSION(:,:,:)   ,POINTER   :: cn2o5
real      ,DIMENSION(:,:,:)   ,POINTER   :: kn2o5
real      ,DIMENSION(:,:,:)   ,POINTER   :: yclno2
real      ,DIMENSION(:,:,:)   ,POINTER   :: ts_o3_profile
real      ,DIMENSION(:,:,:)   ,POINTER   :: p_gca
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_now
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_jan
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_feb
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_mar
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_apr
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_may
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_jun
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_jul
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_aug
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_sep
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_oct
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_nov
real      ,DIMENSION(:,:,:)   ,POINTER   :: oh_gca_dec
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_now
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_jan
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_feb
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_mar
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_apr
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_may
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_jun
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_jul
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_aug
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_sep
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_oct
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_nov
real      ,DIMENSION(:,:,:)   ,POINTER   :: h2o2_gca_dec
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_now
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_jan
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_feb
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_mar
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_apr
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_may
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_jun
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_jul
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_aug
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_sep
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_oct
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_nov
real      ,DIMENSION(:,:,:)   ,POINTER   :: no3_gca_dec
...
real      ,DIMENSION(:,:,:,:) ,POINTER   :: dgnum4d
real      ,DIMENSION(:,:,:,:) ,POINTER   :: dgnumwet4d
real      ,DIMENSION(:,:,:)   ,POINTER   :: qme3d
real      ,DIMENSION(:,:,:)   ,POINTER   :: prain3d
real      ,DIMENSION(:,:,:)   ,POINTER   :: nevapr3d
real      ,DIMENSION(:,:,:)   ,POINTER   :: rate1ord_cw2pr_st3d
real      ,DIMENSION(:,:,:,:) ,POINTER   :: dvmrdt_sv13d
real      ,DIMENSION(:,:,:,:) ,POINTER   :: dvmrcwdt_sv13d
real      ,DIMENSION(:,:,:)   ,POINTER   :: dgnum_a1
real      ,DIMENSION(:,:,:)   ,POINTER   :: dgnum_a2
real      ,DIMENSION(:,:,:)   ,POINTER   :: dgnum_a3
real      ,DIMENSION(:,:,:)   ,POINTER   :: dgnumwet_a1
real      ,DIMENSION(:,:,:)   ,POINTER   :: dgnumwet_a2
real      ,DIMENSION(:,:,:)   ,POINTER   :: dgnumwet_a3
real      ,DIMENSION(:,:,:,:) ,POINTER   :: fracis3d
...
real      ,DIMENSION(:,:,:,:) ,POINTER   :: irr_diag_mozcart
real      ,DIMENSION(:,:,:,:) ,POINTER   :: irr_diag_t1_mozcart
real      ,DIMENSION(:,:,:,:) ,POINTER   :: irr_diag_mozart_mosaic_4bin
real      ,DIMENSION(:,:,:,:) ,POINTER   :: irr_diag_mozart_mosaic_4bin_aq
