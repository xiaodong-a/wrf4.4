                  ...
                  DO IKL=1,NCOND
                    ...
                    IF (DIFFU.NE.0)THEN
                      ...
                      IF (DIFFU == 1)THEN
                        ...
                        IF (DEL2NR.EQ.0)call wrf_error_fatal3("<stdin>",4637,&
 ...
 IF(DEL1N >= 0.0D0) KCOND=11
   ...
   IF(KCOND == 11) THEN
      ...
      DTT = DTNEWL
   	  ...
   	  IF (DTT < 0.0) call wrf_error_fatal3("<stdin>",6928,&
...
"fatal error in ONECOND1-1 (DEL1.GT.0.AND.DEL1N.LT.0), model stop")
    ...
    ELSE
      ...
      DTT = DTNEWL
 	    ...
 	    IF (DTT < 0.0) call wrf_error_fatal3("<stdin>",6974,&
"fatal error in ONECOND1-DEL1N<0:(DTT<0), model stop")
...
"fatal error in ONECOND2 (RW or PW are NaN), model stop")
       ...
       DTT = DTNEWL
 			...
 			IF (DTT < 0.0) call wrf_error_fatal3("<stdin>",7478,&
...
"fatal error in module_mp_fast_sbm (DEL2.GT.0.AND.DEL2N.LT.0), model stop")
 	  ...
 	  ELSE
        ...
        DTT = DTNEWL
 			  ...
 			  IF (DTT < 0.0) call wrf_error_fatal3("<stdin>",7563,&
"fatal error in ONECOND2-DEL2N<0:(DTT<0), model stop")
...
"fatal error in ONECOND3 (RW or PW are NaN), model stop")
  ...
  ENDIF
   ...
   IF (DTT < 0.0) call wrf_error_fatal3("<stdin>",8106,&
